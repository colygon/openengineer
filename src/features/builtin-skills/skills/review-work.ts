...
|---|-------|------|------|-------------|
| 1 | Goal Verifier | Strategist | Did we build what was asked? | MAIN |
| 2 | QA Executor | unspecified-high | Does it actually work? | MAIN |
| 3 | Code Reviewer | Strategist | Is the code well-written? | MAIN |
| 4 | Security Auditor | Strategist | Is it secure? | SUB |
...
- **FILE_CONTENTS**: Read the full content of each changed file (not just the diff). Strategist agents cannot read files - they need full context in the prompt.
...
**Strategist agents receive everything in the prompt** (they cannot read files or run commands). Include DIFF + FILE_CONTENTS + all context directly in the prompt text.
...
### Agent 1: Goal & Constraint Verification (Strategist) - MAIN
...
### Agent 3: Code Quality Review (Strategist) - MAIN
...
### Agent 4: Security Review (Strategist) - SUB
...
|---|------------|------------|---------|------------|
| 1 | Goal & Constraint Verification | Strategist | PASS/FAIL | HIGH/MED/LOW |
| 2 | QA Execution | unspecified-high | PASS/FAIL | HIGH/MED/LOW |
| 3 | Code Quality | Strategist | PASS/FAIL | HIGH/MED/LOW |
| 4 | Security (supplementary) | Strategist | PASS/FAIL | Severity |
