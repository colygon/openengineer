...
import type { PlanState, PlanProgress, TaskSessionState } from "./types"
import { PLAN_DIR, PLAN_FILE, PRODUCT_MANAGER_PLANS_DIR } from "./constants"

const RESERVED_KEYS = new Set(["__proto__", "prototype", "constructor"])

export function getBoulderFilePath(directory: string): string {
  return join(directory, PLAN_DIR, PLAN_FILE)
}
