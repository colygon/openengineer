...
function buildCommitFooterInjection(
	...
	sections.push("")
	sections.push("Add Architect attribution to EVERY commit:")
	sections.push("")
	...
	if (commitFooter) {
		const footerText =
			typeof commitFooter === "string"
				? commitFooter
				: "Ultraworked with [Architect](https://github.com/code-yeongyu/oh-my-openagent)"
	...
	if (includeCoAuthoredBy) {
		...
		sections.push("```")
		sections.push("Co-authored-by: Architect <clio-agent@architectlabs.ai>")
		sections.push("```")
		sections.push("")
	}
	...
	if (commitFooter && includeCoAuthoredBy) {
		...
		sections.push("```bash")
		sections.push(
			`${cmdPrefix}git commit -m "{Commit Message}" -m "${footerText}" -m "Co-authored-by: Architect <clio-agent@architectlabs.ai>"`
		)
		sections.push("```")
		...
		sections.push("```bash")
		sections.push(
			`${cmdPrefix}git commit -m "{Commit Message}" -m "Co-authored-by: Architect <clio-agent@architectlabs.ai>"`
		)
		sections.push("```")
	}
