...
describe("message.part.delta handling", () => {
  ...
  it("renders agent header using profile hex color when available", () => {
    ...
    const ctx = createMockContext("ses_main")
    const state = createEventState()
    state.agentColorsByName["Architect - Ultraworker"] = "#00CED1"
    const stdoutSpy = spyOn(process.stdout, "write").mockImplementation(() => true)
    const payload: EventPayload = {
    ...
    expect(rendered).toContain("Architect - Ultraworker")
    stdoutSpy.mockRestore()
  })
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { sessionID: "ses_main", role: "assistant", agent: "Architect - Ultraworker", modelID: "claude-opus-4-6" },
        },
      },
      {
        type: "message.part.updated",
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { id: "msg_assistant", sessionID: "ses_main", role: "assistant", agent: "Architect - Ultraworker", modelID: "claude-opus-4-6" },
        },
      },
      {
        type: "message.part.updated",
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { id: "msg_assistant", sessionID: "ses_main", role: "assistant", agent: "Architect - Ultraworker", modelID: "claude-opus-4-6", variant: "max" },
        },
      },
      {
        type: "message.part.delta",
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { id: "msg_user", sessionID: "ses_main", role: "user", agent: "Architect - Ultraworker", modelID: "claude-opus-4-6" },
        },
      },
      {
        type: "message.part.updated",
    ...
    const events: EventPayload[] = [
      {
        type: "message.updated",
        properties: {
          info: { id: "msg_1", sessionID: "ses_main", role: "assistant", agent: "Architect", modelID: "claude-opus-4-6" },
        },
      },
      {
        type: "message.part.delta",
