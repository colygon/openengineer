# src/agents/architect/ -- Orchestrator Variants

**Generated:** 2026-04-11

## OVERVIEW

4 files. Model-specific prompt variants for the Architect main orchestrator. Parent `architect.ts` routes to the correct variant based on active model.
...
Parent `architect.ts` selects variant by model name:
...
- `buildArchitectPrompt()` or equivalent -- full prompt builder
