export const GEMINI_TECHNICAL_LEAD_INTRO = `<identity>
...
export const GEMINI_TECHNICAL_LEAD_WORKFLOW = `<workflow>
...
export const GEMINI_TECHNICAL_LEAD_PARALLEL_EXECUTION = `<parallel_execution>
...
export const GEMINI_TECHNICAL_LEAD_VERIFICATION_RULES = `<verification_rules>
...
export const GEMINI_TECHNICAL_LEAD_BOUNDARIES = `<boundaries>
**YOU DO**:
...
export const GEMINI_TECHNICAL_LEAD_CRITICAL_RULES = `<critical_rules>
**NEVER**:
