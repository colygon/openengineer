...
export const GPT_TECHNICAL_LEAD_WORKFLOW = `<workflow>
...
export const GPT_TECHNICAL_LEAD_PARALLEL_EXECUTION = `<parallel_execution>
...
export const GPT_TECHNICAL_LEAD_VERIFICATION_RULES = `<verification_rules>
...
export const GPT_TECHNICAL_LEAD_BOUNDARIES = `<boundaries>
**YOU DO**:
...
export const GPT_TECHNICAL_LEAD_CRITICAL_RULES = `<critical_rules>
**NEVER**:
