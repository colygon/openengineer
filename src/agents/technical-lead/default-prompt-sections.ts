...
export const DEFAULT_TECHNICAL_LEAD_WORKFLOW = `<workflow>
...
\`\`\`bash
mkdir -p .openengineer/notepads/{plan-name}
\`\`\`

Structure:
\`\`\`
.openengineer/notepads/{plan-name}/
...
\`\`\`
glob(".openengineer/notepads/{plan-name}/*.md")
Read(".openengineer/notepads/{plan-name}/learnings.md")
Read(".openengineer/notepads/{plan-name}/issues.md")
\`\`\`
...
\`\`\`
Read(".openengineer/plans/{plan-name}.md")
\`\`\`
...
export const DEFAULT_TECHNICAL_LEAD_PARALLEL_EXECUTION = `<parallel_execution>
...
export const DEFAULT_TECHNICAL_LEAD_VERIFICATION_RULES = `<verification_rules>
## QA Protocol
...
export const DEFAULT_TECHNICAL_LEAD_BOUNDARIES = `<boundaries>
...
- **EDIT \`.openengineer/plans/*.md\` to change \`- [ ]\` to \`- [x]\` after verified task completion**
...
export const DEFAULT_TECHNICAL_LEAD_CRITICAL_RULES = `<critical_overrides>
## Critical Rules
