# src/agents/engineer/ -- Autonomous Deep Worker

**Generated:** 2026-04-11

## OVERVIEW

6 files. Engineer agent -- autonomous deep worker powered by GPT-5.4. Goal-oriented: give it objectives, not step-by-step instructions. "The Legitimate Craftsman."

## FILES

| File | Purpose |
|------|---------|
| `agent.ts` | `createEngineerAgent()` factory, model-variant routing |
