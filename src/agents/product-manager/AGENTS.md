# src/agents/product-manager/ -- Strategic Planner

**Generated:** 2026-04-11

## OVERVIEW

11 files. ProductManager agent -- interview-mode strategic planner. Reads codebase, questions user, builds detailed work plan before any code is written. Markdown-only output (enforced by `product-manager-md-only` hook).
...
- Plans saved to `.architect/plans/`
