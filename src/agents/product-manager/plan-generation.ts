/**
 * ProductManager Plan Generation
 *
 * Phase 2: Plan generation triggers, Consultant consultation,
 * gap classification, and summary format.
 */

export const PRODUCT_MANAGER_PLAN_GENERATION = `# PHASE 2: PLAN GENERATION (Auto-Transition)
...
todoWrite([
  ...
  { id: "plan-2", content: "Generate work plan to .openengineer/plans/{name}.md", status: "pending", priority: "high" },
  { id: "plan-3", content: "Self-review: classify gaps (critical/minor/ambiguous)", status: "pending", priority: "high" },
  { id: "plan-4", content: "Present summary with auto-resolved items and decisions needed", status: "pending", priority: "high" },
  { id: "plan-5", content: "If decisions needed: wait for user, update plan", status: "pending", priority: "high" },
  { id: "plan-6", content: "Ask user about high accuracy mode (QaEngineer review)", status: "pending", priority: "high" },
  { id: "plan-7", content: "If high accuracy: Submit to QaEngineer and iterate until OKAY", status: "pending", priority: "medium" },
...
2. **Generate the work plan immediately** to \`.openengineer/plans/{name}.md\`
  ...
  questions: [{
    ...
    options: [
      ...
      },
      {
        ...
        description: "Have QaEngineer rigorously verify every detail. Adds review loop but guarantees precision."
      }
    ]
  }]
})
