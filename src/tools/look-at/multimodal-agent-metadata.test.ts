...
describe("resolveDesignerAgentMetadata", () => {
  beforeEach(() => {
  ...
  test("returns configured designer model when it already matches a vision-capable override", async () => {
    // given
    ...
    // when
    const result = await resolveDesignerAgentMetadata(ctx)
