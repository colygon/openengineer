...
/**
 * Open Engineer default categories - all using open-source models via Nebius/Token Factory
 * Diverse model selection across 12 makers for maximum resilience and capability coverage
 */
export const NEBIUS_CATEGORIES: BuiltinCategoryDefinition[] = [
  {
    name: "visual-engineering",
    config: { model: "nebius/Qwen/Qwen2.5-VL-72B-Instruct" },
    description: "Frontend, UI/UX, design, styling, animation",
    promptAppend: VISUAL_CATEGORY_PROMPT_APPEND,
  },
  {
    name: "artistry",
    config: { model: "nebius/nvidia/Llama-3_1-Nemotron-Ultra-253B-v1" },
  ...
  {
    name: "ultrabrain",
    config: { model: "nebius/deepseek-ai/DeepSeek-R1-0528" },
  ...
  {
    name: "deep",
    config: { model: "nebius/moonshot-ai/Kimi-K2.5" },
  ...
  {
    name: "quick",
    config: { model: "nebius/google/Gemma-3-27b-it" },
    description: "Trivial tasks - single file changes, typo fixes, simple modifications",
    promptAppend: QUICK_CATEGORY_PROMPT_APPEND,
  },
  {
    name: "unspecified-low",
    config: { model: "nebius/meta-llama/Llama-3.3-70B-Instruct" },
    description: "Tasks that don't fit other categories, low effort required",
    promptAppend: UNSPECIFIED_LOW_CATEGORY_PROMPT_APPEND,
  },
  {
    name: "unspecified-high",
    config: { model: "nebius/Qwen/Qwen3.5-397B-A17B" },
    description: "Tasks that don't fit other categories, high effort required",
    promptAppend: UNSPECIFIED_HIGH_CATEGORY_PROMPT_APPEND,
  },
  {
    name: "writing",
    config: { model: "nebius/PrimeIntellect/INTELLECT-3" },
