...
describe("createTaskList", () => {
  ...
  beforeEach(() => {
    taskDir = join(testProjectDir, ".openengineer/tasks")
  ...
  it("returns empty array when no tasks exist", async () => {
    ...
    const config = {
      architect: {
        tasks: {
          storage_path: join(testProjectDir, ".openengineer/tasks"),
  ...
  it("excludes completed tasks by default", async () => {
    ...
    writeJsonAtomic(join(testProjectDir, ".openengineer/tasks", "T-1.json"), task1)
    writeJsonAtomic(join(testProjectDir, ".openengineer/tasks", "T-2.json"), task2)
  ...
  it("excludes deleted tasks by default", async () => {
   ...
   it("returns summary format with id, subject, status, owner, blockedBy", async () => {
    ...
    writeJsonAtomic(join(testProjectDir, ".openengineer/tasks", "T-1.json"), task)
    ...
    expect(summary.owner).toBe("architect")
  ...
  it("filters blockedBy to only include unresolved (non-completed) blockers", async () => {
    ...
    writeJsonAtomic(join(testProjectDir, ".openengineer/tasks", "T-blocker-completed.json"), blockerCompleted)
    writeJsonAtomic(join(testProjectDir, ".openengineer/tasks", "T-blocker-pending.json"), blockerPending)
    writeJsonAtomic(join(testProjectDir, ".openengineer/tasks", "T-main.json"), mainTask)
