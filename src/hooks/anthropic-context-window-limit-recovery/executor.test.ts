...
import { OpenEngineerConfigSchema } from "../../config"
...
describe("executeCompact lock management", () => {
  ...
  let pluginConfig: ReturnType<typeof OpenEngineerConfigSchema.parse>
  ...
  beforeEach(() => {
    ...
    pluginConfig = OpenEngineerConfigSchema.parse({})
