...
1. **Edit** the plan file \`.openengineer/plans/${planName}.md\`:
   - Change \`- [ ]\` to \`- [x]\` for the completed task
   - Use \`Edit\` tool to modify the checkbox

2. **Read** the plan file AGAIN:
   \`\`\`
   Read(".openengineer/plans/${planName}.md")
   \`\`\`
...
\`\`\`
Glob(".openengineer/notepads/${planName}/*.md")
\`\`\`
...
1. Read \
\`.openengineer/plans/${planName}.md\` again and confirm every remaining unchecked **top-level** task belongs to F1-F4.
