...
import { isStrategistVerified } from "./strategist-verification-detector"
...
function shouldInspectSessionMessagePart(
	...
	return promise === ULTRAWORK_VERIFICATION_PROMISE && isStrategistVerified(partText)
}
...
function shouldInspectTranscriptEntry(
	...
	return promise === ULTRAWORK_VERIFICATION_PROMISE && isStrategistVerified(entryText)
}
