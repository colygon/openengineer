...
import { createAutoLoopEventHandler } from "./auto-loop-event-handler"
...
export function createAutoLoopHook(
  ctx: PluginInput,
  ...
  const checkSessionExists = options?.checkSessionExists
	...
	const event = createAutoLoopEventHandler(ctx, {
		directory: ctx.directory,
	...
	return {
		...
		getState: loopState.getState as () => AutoLoopState | null,
	}
}
