export type AutoLoopStrategy = "reset" | "continue"

export type ParsedAutoLoopArguments = {
  prompt: string
  maxIterations?: number
  completionPromise?: string
  strategy?: AutoLoopStrategy
}

const DEFAULT_PROMPT = "Complete the task as instructed"

export function parseAutoLoopArguments(rawArguments: string): ParsedAutoLoopArguments {
