...
describe("keyword-detector ultrawork routing", () => {
  ...
  test("#given ulw keyword in main session #when chat.message fires #then ultrawork prompt is injected without starting ralph loop", async () => {
    ...
    // when
    await hook["chat.message"]({ sessionID: "main-session", agent: "architect" }, output)
  ...
  test("#given ulw keyword with planner agent #when chat.message fires #then auto-loop startLoop is not invoked", async () => {
    ...
    // when
    await hook["chat.message"]({ sessionID: "main-session", agent: "product-manager" }, output)
  ...
  test("#given partial 'ulw' substring in StatefulWidget #when chat.message fires #then auto-loop startLoop is not invoked", async () => {
    ...
    // when
    await hook["chat.message"]({ sessionID: "any-session", agent: "architect" }, output)
