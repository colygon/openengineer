...
createHooks()
  ...
  │   ├─ createSessionHooks()     # 24: contextWindowMonitor, thinkMode, ralphLoop, modelFallback, runtimeFallback, noArchitectGpt, noEngineerNonGpt, anthropicEffort, intentGate, legacyPluginToast...
  ...
  ├─→ createContinuationHooks()   # 7: todoContinuationEnforcer, technical-lead, stopContinuationGuard, compactionContextInjector...
